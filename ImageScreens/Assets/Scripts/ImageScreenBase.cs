...
namespace ImageScreens.Prefabs
{
    ...
    public abstract class ImageScreenBase : SmallDevice, DownloadCache.IListener
    {
        ...
        // Index of the material containing the screen image texture.
        protected const int SCREEN_MATERIAL_INDEX = 1;
        // Material containing the screen image texture.
        ...
        public override void Awake()
        {
            ...
            screenMaterial = renderer.materials[SCREEN_MATERIAL_INDEX];
        ...
        private void DisplayTexture(Texture newTexture)
        {
            ...
            screenMaterial.mainTexture = newTexture;

            // Update the emission map to the same texture, if the material uses one.
            if (screenMaterial.HasProperty("_EmissionMap"))
            {
                screenMaterial.SetTexture("_EmissionMap", newTexture);
            }
        }
        ...
        private void SlideshowTick()
        {
            ...
            {
                // If not, display an error texture.
                // Later, during the next tick, it will be replaced by whatever image is next in the slideshow.
